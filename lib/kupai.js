...
export function answer(q) {
  ...
  if (has("espresso"))
    return [
      "<b>Espresso</b>: gilingan halus, rasio 1:2 (18g in → 36g out) dalam 25–30 detik. Pakai biji medium-dark biar body tebal, cocok House Blend kami ☕",
      3,
    ];
  ...
  if (has("kirim", "ongkir", "logistik"))
    return [
      "Estimasi logistik flat Rp15.000 (simulasi). Kopi dikemas rapi & dikirim segar. Pakai kode <b>JEJAK2024</b> buat diskon 10% 🎉",
    ];
